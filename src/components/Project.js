...
const projects = [
  {
    ...
    desc: 'Job portal web app with Django and React.js, supporting job posting, applications, JWT authentication, and applicant tracking.',
    url: 'https://jobportel-7f3p.vercel.app/',
  },
  {
    id: '2',
    emoji: '📝',
